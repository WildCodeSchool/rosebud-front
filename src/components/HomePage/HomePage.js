  ...
  return (
    <div className="HomePage">
      ...
      <div className="random__images__wrapper">
        <img className="random__image image__1" src="http://lorempixel.com/640/360/" alt="alt" />
        <img className="random__image image__2" src="http://lorempixel.com/641/361/" alt="alt" />
        <img className="random__image image__3" src="http://lorempixel.com/642/362/" alt="alt" />
        <img className="random__image image__4" src="http://lorempixel.com/643/363/" alt="alt" />
        <img className="random__image image__5" src="http://lorempixel.com/644/364/" alt="alt" />
      ...
      <section className="home__search">
        ...
        <div className="search__results">
          <div className="search__results__buttons">
            <button type="button" className="search__results__button search__results__button--active">Consulter</button>
            <button type="button" className="search__results__button">Participer</button>
          </div>
          <div className="search__results__wrapper">
            <Link to="participation/questionnaire/1" className="search__results__item">
              ...
              <div className="search__results__access"><i className="fa fa-arrow-right" aria-hidden="true" /></div>
            </Link>
          </div>
